...
const CommentBox = () => {
  ...
  const renderMoreComment = (
    <div className={styles.moreComment}>
      ...
      <Comment
        more
        comment="Idrok gomeostazni yoritadi, Xobbs bu muammoni birinchilardan bo'lib yoritib berdi psixologiya nuqtai nazaridan nima deyish mumkin? Bu muammoni birinchilardan bo'lib yoritib berdi psixologiya nuqtai nazaridan nima deyish mumkin? Bu muammoni birinchilardan bo'lib yoritib berdi psixologiya nuqtai nazaridan nima deyish mumkin?"
      />
    </div>
  );
    ...
    <div className={styles.moreFooterText}>
      ...
      <div className={styles.info}>
        <Text
          ...
          textColor={"grey"}
          cursor={"none"}
          text="'Sohil parki' turar joy majmuasi paxra daryosi sohilida, Pavlovskoye qishlog'i va yam qishlog'i yonida, 9-uyda qurilgan. ' Sohil parki' turar joy majmuasi joylashuv, transportga kirish imkoniyati"
        />
      </div>
    </div>
  );
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.comment}>
        ...
        />
        <Comment
          comment="drok gomeostazni yoritadi, Xobbs bu muammoni birinchilardan bo'lib yoritib berdi psixologiya nuqtai nazaridan ..."
          showMore={handleOpenMoreComment}
        />
      </div>
      <div className={styles.transport}>
        ...
        <div className={styles.info}>
          <Text
            ...
            textColor={"grey"}
            cursor={"none"}
            text="'Sohil parki' turar joy majmuasi paxra daryosi sohilida, Pavlovskoye qishlog'i va yam qishlog'i yonida, 9-uyda qurilgan. ' Sohil parki' turar joy majmuasi"
          />
        </div>
        <button
          onClick={handleOpenMoreFooterText}
